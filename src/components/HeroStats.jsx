...
const HeroStats = () => {
  return (
    <div className="w-full border-t border-t-[#262626] grid grid-cols-3 h-[160px] bg-transparent">
        <div className="col-span-1 pr-5 lg:pr-0 flex flex-col justify-center">
        ...
        <div className="col-span-1 px-5 lg:pl-10 flex flex-col justify-center border-x border-x-[#262626]">
        ...
        <div className="col-span-1 pl-5 lg:pl-10 flex flex-col justify-center">
