...
const Hero = () => {
  ...
  return (
    <section className="w-full grid grid-rows-2 lg:grid-cols-5 lg:grid-rows-none bg-[#141414]">
      <div className="row-span-1 lg:col-span-3 self-start bg-transparent flex flex-col items-start justify-start pt-[40px] lg:pt-[100px] px-5 lg:pl-10 lg:pr-0">
      ...
      <div className="row-span-1 lg:col-span-2 self-start bg-transparent pt-[100px] pb-[40px] relative overflow-hidden flex flex-col items-start justify-end px-5 lg:pl-10 lg:pr-0">
