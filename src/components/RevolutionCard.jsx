  ...
  return (
    <div className="col-span-3 lg:col-span-1 p-6 lg:p-[30px] 2xl:p-10 rounded-[10px] 2xl:rounded-xl bg-[#1a1a1a] border border-[#262626]">
        <div className="w-full flex items-center justify-between">
            ...
            <Link to='/' aria-label={location} className={`size-[40px] lg:size-[44px] 2xl:size-[52px] bg-[#FFD11A] rounded-full flex items-center justify-center hover:opacity-85 transition-all duration-300 ease-in-out`}>
