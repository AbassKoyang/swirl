...
const HeroFeaturesGrid = () => {
  return (
    <div className="w-full grid grid-cols-3 border-y border-y-[#262626] px-5 lg:px-0">
        <div className="col-span-3 lg:col-span-1 flex items-center justify-between py-[30px] lg:py-[50px] lg:pl-[50px] 2xl:pl-[162px] border-y border-y-[#262626] lg:border-0">
            <div className="">
        ...
        <div className="col-span-3 lg:col-span-1 flex items-center justify-between py-[30px] lg:py-[50px] lg:pr-[50px] 2xl:pr-[162px] border-y border-y-[#262626] lg:border-0">
            <div className="">
