...
const LandingPageBlog = ({title}) => {
  return (
    <div className="w-full flex items-center justify-between lg:px-10 lg:py-[60px] 2xl:px-[162px] 2xl:py-[80px] border-y border-y-[#262626]">
      <div className="flex lg:gap-[10px] items-center">
        <div className="lg:size-[60px] 2xl:size-20 rounded-full overflow-hidden">
          <img src={blogAuthorPic1} alt="Profile pic" className='w-full object-cover' />
        </div>
        <div className="">
          <h4 className='font-inter font-medium text-white lg:text-lg 2xl:text-xl mt-[2px]'>John Techson</h4>
          <p className='font-inter font-regular text-[#98989A] lg:text-[16px] 2xl:text-lg'>Cloud Computing</p>
        </div>
      </div>

      <div className="flex flex-col">
        <h5 className='font-semibold text-[#98989A] lg:text-lg 2xl:text-xl lg:mb-6 2xl:mb-[30px]'>October 15, 2023</h5>
        <h3 className='font-inter font-semibold text-white lg:text-[16px] 2xl:text-[26px] lg:mb-[6px] mb-[10px]'>The Quantum Leap in Computing</h3>
        <p className='font-inter font-regular text-[#98989A] lg:text-[16px] 2xl:text-lg lg:mb-6 mb-[30px]'>Explore the revolution in quantum computing, its applications, and its potential impact on various industries.</p>

        <div className="flex lg:gap-2 2xl:gap-[10px]">
          <button className='flex items-center lg:px-3 lg:py-[6px] 2xl:px-4 2xl:py-2 lg:gap-[2px] 2xl:gap-1 lg:rounded-3xl bg-[#1A1A1A] border border-[#262626]'>
            ...
            <p className='font-kumbh font-normal  text-[#98989A] lg:text-sm 2xl:text-lg'>24.5k</p>
          </button>
          <button className='flex items-center lg:px-3 lg:py-[6px] 2xl:px-4 2xl:py-2 lg:gap-[2px] 2xl:gap-1 lg:rounded-3xl bg-[#1A1A1A] border border-[#262626] group'>
          <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className='font-kumbh font-normal  text-[#98989A] lg:text-sm 2xl:text-lg'>50</p>
          </button>
          <button className='flex items-center lg:px-3 lg:py-[6px] 2xl:px-4 2xl:py-2 lg:gap-[2px] 2xl:gap-1 lg:rounded-3xl bg-[#1A1A1A] border border-[#262626] group'>
          <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            <title>Share</title>
            ...
            <p className='font-kumbh font-normal  text-[#98989A] lg:text-sm 2xl:text-lg'>20</p>
          </button>
        </div>
      </div>
