...
const SubheadingCon = ({styles, text, buttonText, heading}) => {
  return (
    <div className="w-full bg-[#1A1A1A] py-[40px] px-5 lg:py-[80px] lg:px-10 2xl:py-[120px] 2xl:px-[162px] border-y border-y-[#262626]  flex flex-col justify-center items-between">
        <div className="f">
