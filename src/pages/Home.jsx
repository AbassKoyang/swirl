    ...
    <section className="w-full min-h-screen bg-[#141414] max-w-[1900px]">
      ...
      <div className="w-full grid grid-cols-5 px-5 lg:px-10 2xl:px-[162px] bg-[#141414]">
        <div className="col-span-2 flex flex-col justify-center 2xl:pt-[80px] 2xl:pr-20 border-r border-r-[#262626]">
          <img src={ebookIcon} alt="Ebook Icon" className="2xl:size-20 2xl:mb-[50px]" />
          <h3 className="font-kumbh font-semibold text-white 2xl:text-[40px] 2xl:mb-4">Ebooks</h3>
          <p className="font-normal font-inter text-[#98989A] 2xl:text-xl 2xl:mb-4">Explore our collection of ebooks covering a wide spectrum of future technology topics.</p>
          <img src={usersAvatar} alt="Avatar group" className="2xl:w-[193px] 2xl:h-[70px] 2xl:mb-[50px]" />
          ...
          <div className="w-fit flex items-center gap-[50px] 2xl:p-[30px] 2xl:mt-[60px] rounded-xl bg-[#1A1A1A] border border-[#262626]">
            <div className="">
              <p className="font-inter 2xl:text-lg text-[#98989A] 2xl:mb-1">Downloaded by</p>
              <h5 className="text-white font-inter font-semibold 2xl:text-2xl">10k+ Users</h5>
            </div>
            <img src={usersAvatar} alt="Users Avatar Grouped together" className="2xl:w-[193px] 2xl:h-[70px]" />
          </div>
        </div>
