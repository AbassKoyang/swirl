  ...
  return (
    <section className="w-full min-h-screen bg-[#141414] max-w-[1900px]">
      ...
      <div className="w-full grid grid-cols-3 border-b border-b-[#262626]">
        <div className="col-span-1 2xl:pl-[162px] 2xl:pr-[80px] border-r border-r-[#262626] flex flex-col justify-center">
          <img src={techBlogIcon} alt="Tech blog icon" className="2xl:size-[80px]" />
          <h3 className="capitalize font-semibold font-kumbh text-white 2xl:text-3xl 2xl:mt-10">Swirl technology blog</h3>
          <p className="font-normal font-inter text-[#98989A] 2xl:text-[16px] 2xl:mt-[10px]">Stay informed with our blog section dedicated to future technology.</p>
        </div>
        <div className="col-span-2 grid grid-cols-2 gap-5 2xl:p-[80px] 2xl:pr-[162px]">
      ...
      <div className="w-full grid grid-cols-3 border-b border-b-[#262626]">
        <div className="col-span-1 2xl:pl-[162px] 2xl:pr-[80px] border-r border-r-[#262626] flex flex-col justify-center">
          <img src={techBlogIcon} alt="Tech blog icon" className="2xl:size-[80px]" />
          <h3 className="capitalize font-semibold font-kumbh text-white 2xl:text-3xl 2xl:mt-10">Research Insights Blogs</h3>
          <p className="font-normal font-inter text-[#98989A] 2xl:text-[16px] 2xl:mt-[10px]">Dive deep into future technology concepts with our research section.</p>
        </div>
        <div className="col-span-2 grid grid-cols-2 gap-5 2xl:p-[80px] 2xl:pr-[162px]">
